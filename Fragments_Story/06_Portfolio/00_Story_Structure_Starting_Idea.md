...
That became one of the main things I started testing while building Fragments.
...
That became important to me because it means a story might create different outcomes without presenting a direct choice.
...
For game-facing ideas, that might become:

> story -> experience -> emotion -> reason -> behavior -> atmosphere -> quest logic

This helped me think about why the same action can mean different things to different characters.
...
Fragments is still in development, but working on it has made me think more carefully about structure.

I keep testing whether meaning can be felt before it is understood.

I keep testing whether explanation is not always the strongest way to communicate an idea.

I keep testing whether connection can already exist before I recognize it.

I keep testing whether small visible details can become anchors for larger systems.

Most of all, I keep returning to the idea that complex ideas only matter when they return to people, feeling, and experience.
