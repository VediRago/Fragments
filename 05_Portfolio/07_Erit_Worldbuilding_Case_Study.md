...
If the idea expands, it becomes:

> behavior -> atmosphere -> history

For quest thinking, it becomes:

> world pressure -> character need -> obstacle -> approaches -> consequence

This means a system should begin with something someone experienced.

That experience creates an emotional wound.

The wound becomes a reason.
...
The calendar became one of the clearest examples of perception changing meaning.

The question began practically:

> What year is Erit's era in?

That became:

> What event was important enough to reset time?

The answer became Viriatus.

But the important part is that AVD does not begin simply when Viriatus privately dies.

AVD begins when Ermerus publicly declares Regulatus.

The calendar does not mark only death.

It marks the moment power successfully defines what the death means.

To loyal citizens, AVD means civilization began after Viriatus's noble sacrifice.

To forbidden historians, AVD means the world began counting from a lie.
...
Regulatus is not only law, religion, or government policy.
...
They may believe obedience means maturity.

They may believe gratitude proves moral worth.

They may believe accepting their place protects the whole.
...
This allows different people inside the same world to react differently.

Possible system relationships include:
...
- Phil and Abby use sarcasm to hide affection.
- House Ventari uses pride to hide control.

## Quest Potential

This worldbuilding is not being built to create quests first.
...
The chip controls identity, movement, treatment access, and legal existence.

Different approaches could involve bribery, medicine, black-market surgery, forged records, political protection, or betrayal.
...
Instead, I am testing whether each detail can answer at least one of these questions:
